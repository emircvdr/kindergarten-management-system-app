...
const EmployeeList = () => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params: any) => {
        return (
          <Edit onClick={() => navigate(`/employee/edit/${params.row.id}`)}>
            Düzenle
          </Edit>
        );
      },
  ...
  const [rows, setRows] = React.useState<IEmployee.IEmployee[]>([]);
  const [selectedRow, setSelectedRow] = React.useState<IEmployee.IEmployee[]>(
    []
  );
  ...
  React.useEffect(() => {
    KindergartenAPI.GetEmployees().then((res) => {
